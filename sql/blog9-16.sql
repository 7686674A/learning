...
CREATE TABLE `blog` (
  ...
  `file` text COMMENT '图片',
  `file2` text COMMENT '多图',
  PRIMARY KEY (`id`)
...
-- Records of blog
-- ----------------------------
INSERT INTO `blog` VALUES ('1', 'test', 'sadasdas', '1', '1', '2015-00-00 00:00:00', '2015-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('2', 'aaaaa', '<p>safaf</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('3', '123456', '<p>okok,interesting!!!</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('4', 'warning', '<h1>fsafasfasf</h1><pre>&lt;?php\r\n<span class=\"redactor-invisible-space\">    echo \"hellow world\";\r\n</span>?&gt;</pre>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('5', 'test may ok', '<p>test may ok</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('6', '图片测试', '<p>图片测试</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null, null);
INSERT INTO `blog` VALUES ('7', 'picture', '<p>picture</p>', '1', '2', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'uploads/4536966H2X.jpg', 'uploads/4536966H2X.jpg');
INSERT INTO `blog` VALUES ('11', '图片测试3', '<p>图片测试3</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'uploads/461191FARx.png', 'uploads/461191FARx.png');
INSERT INTO `blog` VALUES ('12', '图片测试4', '<p>图片测试4</p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'uploads/526814NaFt.png', 'uploads/526836uPxb.jpg,uploads/526837SJuK.jpg');
INSERT INTO `blog` VALUES ('13', '图片测试5', '<p style=\"text-align: center;\">图片测试5<span class=\"redactor-invisible-space\"><span class=\"redactor-invisible-space\"></span></span></p>', '1', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 'uploads/527297pim2.jpg', 'uploads/527307jVPv.jpg,uploads/527412GpsE.png');
...
INSERT INTO `blog_category` VALUES ('6', '2');
INSERT INTO `blog_category` VALUES ('7', '2');
INSERT INTO `blog_category` VALUES ('11', '2');
INSERT INTO `blog_category` VALUES ('12', '2');
INSERT INTO `blog_category` VALUES ('13', '1');
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES ('1', 'haha3');
...
CREATE TABLE `file` (
  ...
  `file` text COLLATE utf8_unicode_ci COMMENT '图片',
  PRIMARY KEY (`id`)
...
-- Records of file
-- ----------------------------
INSERT INTO `file` VALUES ('1', './uploads/test.png');
